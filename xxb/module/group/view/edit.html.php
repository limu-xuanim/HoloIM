...
<form method='post' id='ajaxForm' action='<?php echo inlink('edit', "id={$group->id}");?>'>
  <div style="padding: 8px 32px;">
    <div class='group-form-row'>
      ...
      <?php echo html::input('name', $group->name, "class='form-control group-form-input'");?>
    </div>
    <div class='group-form-row'>
      <label class='group-form-label'><?php echo $lang->group->desc;?></label>
      <?php echo html::textarea('desc', $group->desc, "rows='5' class='form-control group-form-input'");?>
    </div>
