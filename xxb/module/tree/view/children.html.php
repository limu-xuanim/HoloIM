  ...
  <div class='panel'>
    ...
    <div class='panel-body' id='childList'>
      ...
      foreach($children as $child)
      {
          ...
          echo "<div class='col-xs-6  col-md-offset-2'>" . html::input("children[$child->id]", $child->name, "class='form-control' $disabled") . "</div>";
      ...
      for($i = 0; $i < TREE::NEW_CHILD_COUNT ; $i ++)
      {
          ...
          echo "<div class='col-xs-6  col-md-offset-2'>" . html::input("children[]", '', "class='form-control' placeholder='{$this->lang->category->common}'") . "</div>";
      ...
      echo "<div class='form-group'><div class='col-xs-8 btns'>" . $button . "</div></div>";
