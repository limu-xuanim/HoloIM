...
ZEND_API void zend_signal_handler(int signo, siginfo_t *siginfo, void *context);
ZEND_API void zend_signal_globals_ctor(zend_signal_globals_t *signals_globals);
ZEND_API void zend_signal_globals_dtor(zend_signal_globals_t *signals_globals);
ZEND_API void zend_signal_handler_defer(int signo);
